...
export default function StoryCard({
  ...
  return (
    <div className='flex h-140 w-full'>
      <div className='animate-swing-in-left-fwd flex h-140 w-full flex-col items-center gap-6 rounded-r-2xl border-y-1 border-gray-400 bg-white p-4 pt-10 shadow-2xl'>
      ...
      <div className='h-full w-4 rounded-r-2xl border-t-1 border-r-1 border-b-1 border-gray-400' />
      <div className='h-full w-4 rounded-r-2xl border-t-1 border-r-1 border-b-1 border-gray-400' />
      <div className='h-full w-4 rounded-r-2xl border-t-1 border-r-1 border-b-1 border-gray-400' />
      <div className='h-full w-4 rounded-r-2xl border-t-1 border-r-1 border-b-1 border-gray-400' />
    </div>
