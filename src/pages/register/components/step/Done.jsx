  ...
  return (
    <div className='flex h-90 w-80 flex-col gap-y-2 rounded-2xl bg-white p-6 text-center shadow-xl outline-1 outline-offset-[-1px] outline-gray-100'>
      ...
      <div className='rounded-xl bg-gray-50 p-3'>
        <div className='flex cursor-pointer flex-wrap justify-center text-lg text-blue-600 underline'>
          <span>https://safeguard.app/profile/</span>
          <span>2xa5f668pjf5mygmi</span>
        </div>
      </div>
      <button className='flex w-full items-center justify-center gap-2 rounded-xl bg-blue-100 px-4 py-3 text-lg font-medium text-blue-700'>
...
export default function Done() {
  return (
    <div className='flex flex-col items-center gap-8'>
      ...
      <div className='grid size-32 place-items-center rounded-full bg-gradient-to-br from-green-300 to-green-500'>
        <img src='/icons/register-done.svg' alt='완료' className='size-12' />
      </div>
      <ResultSection />
    </div>
  );
